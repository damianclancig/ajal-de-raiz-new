...
export const translations = {
  ...
  'Please_enter_email': { en: 'Please enter an email address.', es: 'Por favor, ingresa un correo electrónico.', pt: 'Por favor, insira um endereço de e-mail.' },
  'Verification_Required': { en: 'Verification Required', es: 'Verificación Requerida', pt: 'Verificação Necessária' },
  'Please_complete_recaptcha': { en: 'Please complete the reCAPTCHA.', es: 'Por favor, completa el reCAPTCHA.', pt: 'Por favor, complete o reCAPTCHA.' },
  'Thank_You': { en: 'Thank You!', es: '¡Gracias!', pt: 'Obrigado!' },
  'Contact_Success_Desc': { en: 'We have received your request. We will contact you soon.', es: 'Hemos recibido tu solicitud. Nos pondremos en contacto pronto.', pt: 'Recebemos sua solicitação. Entraremos em contato em breve.' },
  ...
  'Weak': { en: 'Weak', es: 'Débil', pt: 'Fraca' },
  'Medium': { en: 'Medium', es: 'Media', pt: 'Média' },
  'Strong': { en: 'Strong', es: 'Fuerte', pt: 'Forte' },
  'Very_Strong': { en: 'Very Strong', es: 'Muy Fuerte', pt: 'Muito Forte' },
  'Password_Ready_Secure': { en: 'Ready! Your password is secure.', es: '¡Listo! Tu contraseña es segura.', pt: 'Pronto! Sua senha é segura.' },
  ...
  'Profile_Picture': { en: 'Profile Picture', es: 'Foto de Perfil', pt: 'Foto de Perfil' },
  'Change_Photo': { en: 'Change Photo', es: 'Cambiar Foto', pt: 'Mudar Foto' },
  'Remove_Photo': { en: 'Remove Photo', es: 'Eliminar Foto', pt: 'Remover Foto' },
  'Uploading_Profile_Image': { en: 'Uploading profile image...', es: 'Subiendo imagen de perfil...', pt: 'Enviando imagem de perfil...' },
  'Profile_Image_Updated': { en: 'Profile image updated.', es: 'La imagen de perfil ha sido actualizada.', pt: 'A imagem de perfil foi atualizada.' },
  'Profile_Updated': { en: 'Profile Updated', es: 'Perfil Actualizado', pt: 'Perfil Atualizado' },
  ...
  'DELETE_CONFIRM_WORD': { en: 'DELETE', es: 'ELIMINAR', pt: 'APAGAR' },
  ...
  'Product_Care': { en: 'Product Care', es: 'Cuidados del Producto', pt: 'Cuidados do Produto' },
  'Use_symbols_for_bullets': { en: 'Use the following symbols for bullets:', es: 'Usa los siguientes símbolos para las viñetas:', pt: 'Use os seguintes símbolos para os marcadores:' },
  ...
  'Uploading_Dots': { en: 'Uploading...', es: 'Subiendo...', pt: 'Enviando...' },
  'Image_Preview': { en: 'Image Preview', es: 'Vista previa de la imagen', pt: 'Pré-visualização da Imagem' },
  'Delete_Image': { en: 'Delete Image', es: 'Eliminar imagen', pt: 'Excluir imagem' },
  'Title_Required': { en: 'Title is required', es: 'El título es requerido', pt: 'O título é obrigatório' },
  'Description_Required': { en: 'Description is required', es: 'La descripción es requerida', pt: 'A descrição é obrigatória' },
  'Price_Required': { en: 'Price is required', es: 'El precio es requerido', pt: 'O preço é obrigatório' },
  'Service_Updated': { en: 'Service Updated', es: 'Servicio Actualizado', pt: 'Serviço Atualizado' },
  'Service_Created': { en: 'Service Created', es: 'Servicio Creado', pt: 'Serviço Criado' },
  'Service_Saved_Success': { en: 'The service has been saved successfully.', es: 'El servicio ha sido guardado exitosamente.', pt: 'O serviço foi salvo com sucesso.' },
  'Edit_Service': { en: 'Edit Service', es: 'Editar Servicio', pt: 'Editar Serviço' },
  'Create_New_Service': { en: 'Create New Service', es: 'Crear Nuevo Servicio', pt: 'Criar Novo Serviço' },
  'Service_Form_Description': { en: 'Complete the details of the service you offer.', es: 'Completa los detalles del servicio que ofreces.', pt: 'Preencha os detalhes do serviço que você oferece.' },
  'Service_Title': { en: 'Service Title', es: 'Título del Servicio', pt: 'Título do Serviço' },
  'Ex_Service_Title': { en: 'Ex: Kokedama Maintenance', es: 'Ej: Mantenimiento de Kokedamas', pt: 'Ex: Manutenção de Kokedamas' },
  'Ex_Service_Price': { en: 'Ex: $25.000 per hour', es: 'Ej: $25.000 por hora', pt: 'Ex: $25.000 por hora' },
  'Icon': { en: 'Icon', es: 'Icono', pt: 'Ícone' },
  'Select_an_icon': { en: 'Select an icon', es: 'Selecciona un ícono', pt: 'Selecione um ícone' },
  'Short_Description': { en: 'Short Description', es: 'Descripción Corta', pt: 'Descrição Curta' },
  'Short_Description_Placeholder': { en: 'An attractive summary of the service.', es: 'Un resumen atractivo del servicio.', pt: 'Um resumo atraente do serviço.' },
  'Details_Checklist': { en: 'Details (Checklist)', es: 'Detalles (Checklist)', pt: 'Detalhes (Checklist)' },
  'Details_Placeholder': { en: 'Write each detail on a new line...', es: 'Escribe cada detalle en una nueva línea...', pt: 'Escreva cada detalhe em uma nova linha...' },
  'Details_Helper_Text': { en: 'Each line will become an item in the details list.', es: 'Cada línea se convertirá en un ítem de la lista de detalles.', pt: 'Cada linha se tornará um item na lista de detalhes.' },
  'Additional_Note_Optional': { en: 'Additional Note (Optional)', es: 'Nota Adicional (Opcional)', pt: 'Nota Adicional (Opcional)' },
  'Ex_Additional_Note': { en: 'Ex: Additional cost for home pickup.', es: 'Ej: Costo adicional por retiro a domicilio.', pt: 'Ex: Custo adicional para retirada em casa.' },
  'Save_Service': { en: 'Save Service', es: 'Guardar Servicio', pt: 'Salvar Serviço' },
